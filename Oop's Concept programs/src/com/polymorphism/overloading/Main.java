...
public class Main {
	...
	/*
	 * rule for two arg primitives
	 * 
	 * primitives Direct match---> implicit promotion--->object-->C.E........... (if
	 * we write two arg object method then it will not go for autoboxing ) But if
	 * not written any two arg object method then it will go through below scenario
	 * i.e Direct match--->implicit promotion---> autoboxing--->wrapper class
	 * parent/number--> super parent /object-->C.E
	 * 
	 * rule for two object Direct match(own class object)---> parent class(if exist)
	 * ---> object class---> C.E
	 * 
	 * RULE FOR TWO ARG WRAPPER CLASS OBJECT direct match-->wrapper class
	 * parent/number-->super parent/object -->Autounboxing (Convert Integer to int
	 * )--->C.E
	 */
